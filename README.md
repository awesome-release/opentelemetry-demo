...
| `compose.yaml`                        | A Docker Compose file prepared for Release            |
| `release-compose.sh`                  | The bash script used to prepare `compose.yaml`        |

## Release Quickstart using template files
...
add a link below. The community is committed to maintaining the project and
